                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4 align-self-end mb-2">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="is_replacement" value="1" id="isReplacementCheckbox" @checked(old('is_replacement')=='1') onchange="toggleReplacementDate()">
                    ...
                    <div class="col-md-4 align-self-end mb-2">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="absen_darimana_saja" value="1" id="absenDarimanaSajaCheckbox" @checked(old('absen_darimana_saja')=='1')>
                    ...
                    <div class="col-md-4" id="replacementDateField" style="display: none;">
                        ...
                        <input type="date" name="replacement_date" id="replacement_date" class="form-control" value="{{ old('replacement_date') }}">
                    </div>
                </div>
